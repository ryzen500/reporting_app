...
class LoadDataFormLaporanExcelKrs {
    private $conn;
    private $limit;
    private $offset;
    private $periode;
    ...
    private function GETTotalCount() {
        // Prepare count query
        $countSql = "SELECT COUNT(*) as total FROM tb_self_assessment WHERE is_deleted = false";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $dataLoader = new LoadDataFormLaporanExcelKrs($conn, $limit, $offset, $filters);
