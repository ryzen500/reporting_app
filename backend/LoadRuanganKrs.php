...
class LoadRuanganKrs {
    ...
    public function getData() {
        ...
        $query1 = "SELECT * FROM ruangan_m where instalasi_id in (4,76) AND ruangan_aktif=true ORDER BY ruangan_nama asc";
...
$dropdown = new LoadRuanganKrs($conn);
